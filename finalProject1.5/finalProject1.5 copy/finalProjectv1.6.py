...
batteryDisplay = pygwidgets.DisplayText(window,(1100 , 45), battery, textColor = BLACK , fontSize = 50)
...
#level 1 screen
        ...
        cityPowerDemand.setValue(powerDemand)
        batteryDisplay.setValue(battery)
